...
@Mapper
@Repository
public interface AcctgTransInterfaceExtMapper {

    @Insert({
        "insert into acctg_trans_interface_ext (id, stato, ",
    ...
    int insert(AcctgTransInterfaceExt row);
    ...
    @Select({
        ...
        "from acctg_trans_interface_ext",
    ...
    AcctgTransInterfaceExt selectByPrimaryKey(String id);
    ...
    List<AcctgTransInterfaceExt> selectAll();
