...
public enum ContextPermissionPrefixEnum {
    ...
    public static ContextPermissionPrefixEnum getByCode(String code) {
        try {
            return Enum.valueOf(ContextPermissionPrefixEnum.class, code);
        }
        catch (Exception e) {
            return null;
        }
    ...
    public static ContextPermissionPrefixEnum getByPermissionPrefix(String permissionPrefix) {
        for (ContextPermissionPrefixEnum context : ContextPermissionPrefixEnum.values()) {
            if (context.getPermissionPrefix().equals(permissionPrefix)) {
                return context;
            }
        }
        return null;
