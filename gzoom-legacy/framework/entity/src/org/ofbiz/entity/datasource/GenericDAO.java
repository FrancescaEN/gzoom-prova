...
public class GenericDAO {
    ...
    private int singleInsert(GenericEntity entity, ModelEntity modelEntity, List<ModelField> fieldsToSave, SQLProcessor sqlP) throws GenericEntityException {
        ...
        boolean createUserLoginIsField = modelEntity.isField(ModelEntity.CREATE_USER_LOGIN_ID_FIELD);
        if (createUserLoginIsField  && (!entity.getIsFromEntitySync() || entity.get(ModelEntity.CREATE_USER_LOGIN_ID_FIELD) == null)) {
            entity.set(ModelEntity.CREATE_USER_LOGIN_ID_FIELD, GenericDelegator.getCurrentUserIdentifier());
            addFieldIfMissing(fieldsToSave, ModelEntity.CREATE_USER_LOGIN_ID_FIELD, modelEntity);
        }
    ...
    private int singleUpdate(GenericEntity entity, ModelEntity modelEntity, List<ModelField> fieldsToSave, SQLProcessor sqlP) throws GenericEntityException {
        ...
        if (modelEntity.isField(ModelEntity.USER_LOGIN_ID_FIELD) && (!entity.getIsFromEntitySync() || entity.get(ModelEntity.USER_LOGIN_ID_FIELD) == null)) {
            entity.set(ModelEntity.USER_LOGIN_ID_FIELD, GenericDelegator.getCurrentUserIdentifier());
            addFieldIfMissing(fieldsToSave, ModelEntity.USER_LOGIN_ID_FIELD, modelEntity);
        }
    ...
    public int updateByCondition(ModelEntity modelEntity, Map<String, ? extends Object> fieldsToSet, EntityCondition condition, SQLProcessor sqlP) throws GenericEntityException {
        ...
        List<EntityConditionParam> ecpList = FastList.newInstance();
        sql += " WHERE " + condition.makeWhereString(modelEntity, ecpList, this.datasourceInfo, this.modelFieldTypeReader);
    ...
    public void select(GenericEntity entity, SQLProcessor sqlP) throws GenericEntityException {
        ...
        sqlBuffer.append(SqlJdbcUtil.makeFromClause(modelEntity, datasourceInfo, this.modelFieldTypeReader));
        sqlBuffer.append(SqlJdbcUtil.makeWhereClause(modelEntity, modelEntity.getPkFieldsUnmodifiable(), entity, "AND", datasourceInfo, modelFieldTypeReader));
        ...
        try {
            ...
            if (Debug.timingOn()) {
                if ("mssql".equals(datasourceInfo.fieldTypeName)) {
                    Debug.logTiming("Run query in " + queryTotalTime + " milliseconds: " + sqlP, module);
                } else {
                    Debug.logTiming("Run query in " + queryTotalTime + " milliseconds: " + sqlP.getPreparedStatement(), module);
                }
            }
    ...
    public EntityListIterator selectListIteratorByCondition(ModelEntity modelEntity, EntityCondition whereEntityCondition,
        ...
        sqlBuffer.append(SqlJdbcUtil.makeOrderByClause(modelEntity, orderByExpanded, datasourceInfo, this.modelFieldTypeReader));
        ...
        long queryTotalTime = queryEndTime - queryStartTime;
        if (queryTotalTime > 150) {
            Debug.log("Run query in " + queryTotalTime + " milliseconds: " + sql + " where clause:" + whereEntityConditionParams, module);
        } else if (Debug.timingOn()) {
            Debug.logTiming("Run query in " + queryTotalTime + " milliseconds: " + sql + " where clause:" + whereEntityConditionParams, module);
        }
    ...
    protected StringBuilder makeConditionWhereString(ModelEntity modelEntity, EntityCondition whereEntityCondition, List<EntityCondition> viewWhereConditions, List<EntityConditionParam> whereEntityConditionParams) throws GenericEntityException {
        ...
        if (whereEntityCondition != null) {
            entityCondWhereString = whereEntityCondition.makeWhereString(modelEntity, whereEntityConditionParams, this.datasourceInfo, this.modelFieldTypeReader);
        }
        ...
        if (modelViewEntity != null) {
            ...
            if (viewWhereEntityCondition != null) {
                viewEntityCondWhereString = viewWhereEntityCondition.makeWhereString(modelEntity, whereEntityConditionParams, this.datasourceInfo, this.modelFieldTypeReader);
            }
        }

        String viewClause = SqlJdbcUtil.makeViewWhereClause(modelEntity, datasourceInfo, modelFieldTypeReader);
    ...
    protected StringBuilder makeConditionHavingString(ModelEntity modelEntity, EntityCondition havingEntityCondition, List<EntityCondition> viewHavingConditions, List<EntityConditionParam> havingEntityConditionParams) throws GenericEntityException {
        ...
        if (havingEntityCondition != null) {
            entityCondHavingString = havingEntityCondition.makeWhereString(modelEntity, havingEntityConditionParams, this.datasourceInfo, this.modelFieldTypeReader);
        }
        ...
        if (modelViewEntity != null) {
            ...
            if (viewHavingEntityCondition != null) {
                viewEntityCondHavingString = viewHavingEntityCondition.makeWhereString(modelEntity, havingEntityConditionParams, this.datasourceInfo, this.modelFieldTypeReader);
            }
        }
    ...
    public List<GenericValue> selectByMultiRelation(GenericValue value, ModelRelation modelRelationOne, ModelEntity modelEntityOne,
        ...
        sqlsb.append(SqlJdbcUtil.makeOrderByClause(modelEntityTwo, orderBy, true, datasourceInfo, modelFieldTypeReader));
    ...
    public int deleteByCondition(ModelEntity modelEntity, EntityCondition condition, SQLProcessor sqlP) throws GenericEntityException {
        ...
        List<EntityConditionParam> ecpList = FastList.newInstance();
        String whereCondition = condition.makeWhereString(modelEntity, ecpList, this.datasourceInfo, this.modelFieldTypeReader);
