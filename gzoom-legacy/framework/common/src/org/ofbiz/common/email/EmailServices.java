...
public class EmailServices {
    ...
    public static Map<String, Object> sendMail(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        String starttls = (String) context.get("starttls");
        ...
        if (sendType == null || sendType.equals("mail.smtp.host")) {
            ...
            if (UtilValidate.isEmpty(starttls)) {
                starttls = UtilProperties.getPropertyValue("general.properties", "mail.smtp.starttls.enable");
            }
        ...
        try {
            ...
            if (UtilValidate.isNotEmpty(starttls)) {
        ...
        try {
            ...
            while (nestedException instanceof MessagingException) {
            	...
            	nestedException = ((MessagingException) nestedException).getNextException();
            }
