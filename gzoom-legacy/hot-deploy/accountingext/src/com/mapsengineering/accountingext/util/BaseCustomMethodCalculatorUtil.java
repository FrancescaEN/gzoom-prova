...
public class BaseCustomMethodCalculatorUtil {
	...
	public static final String NUMDEN = "NUMDEN";
	...
	public static final String perfAmountActual = "perfAmountActual";
	public static final String perfAmountTarget = "perfAmountTarget";
