...
<script type="text/javascript">
    ...
    ReasonPopupMgr.validate = function() {
    	...
    	var childStruct = '${parameters.childStruct?if_exists}';
        ...
        new Ajax.Request(target, {
            ...
            onSuccess: function(transport) {
                ...
                modal_box_messages.alert("${uiLabelMap.ChangeStatusAll_finished}<br><br>${uiLabelMap.ChangeStatusAll_itemSuccess}" + data.itemSuccess + "<br><br>${uiLabelMap.ChangeStatusAll_itemFailed}" + data.itemFailed + "<br><br>${uiLabelMap.ChangeStatusAll_itemWarning}" + data.itemWarning + failMessageList
                , '${uiLabelMap.ConfirmMassiveChangeStatus}', function(element) {
    ...
    ReasonPopupMgr.showChangeStatusPopup = function() {
        ...
        if (val != '') {
            ...
            if (Object.isElement(popup)) {
                ...
                Modalbox.show(popup, {title: '${uiLabelMap.ConfirmMassiveChangeStatus}'});
            }
        }
    };
