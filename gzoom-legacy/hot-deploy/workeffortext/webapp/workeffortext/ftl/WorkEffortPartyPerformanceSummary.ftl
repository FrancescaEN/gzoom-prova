	        ...
	        <tbody>
	            ...
	            <#list listIt as workEffort>
	                ...
	                <tr <#if index%2 != 0>class="alternate-row"</#if>>
	                    ...
	                    <td>
	                    	<#if openViewRootDetail == "Y" && security.hasEntityPermission("PARTYMGR", "_VIEW", userLogin)>
