...
<#if renderNewRow != "Y">
    ...
    <#-- RENDER DEL TD - BODY -->
        ...
        <input type="hidden" name="entityName_o_${index}" value="WorkEffortMeasure"/>
...
<#else> 
    ...
    <div  class="droplist_field" id="WETVST003${accountTypeEnumId?if_exists}_WorkEffortTransactionView-${context.relationTitle?if_exists}_glAccountId">
        ...
        <input type="hidden" name="glAccountId_o_${index}" value=""  class="droplist_code_field"/>
        ...
        <input type="text" id="WETVST003${accountTypeEnumId?if_exists}_WorkEffortTransactionView-${context.relationTitle?if_exists}_glAccountId_o_${index}_edit_field" name="accountName_glAccountId_o_${index}" size="100" maxlength="255" value=""  class="droplist_edit_field"/>
