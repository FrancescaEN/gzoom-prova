...
<#if "Y" == parameters.rootInqyTree?if_exists?default('N') || "Y" == parameters.isForcedReadOnly?if_exists?default('N') || "Y" == isPosted?if_exists || crudEnumId?if_exists == "NONE" || isReadOnly?if_exists || !checkWorkEffortPermissions || !isAdminPermission>
   													...
   													<tr>
   														<#if multiTypeLang?has_content && multiTypeLang?default('NONE') == 'NONE'>
															...
															<td class="widget-area-style">
				   												<textarea class="encode_output" name="comments" cols="60" rows="4" id="WorkEffortAssignmentViewManagementFormPanel_comments" <#if commentsReadOnly || isReadOnlyRow> readonly="readonly"</#if>>${comments?if_exists}</textarea>
				   											</td>
														<#else>
	   														<td class="">
   																<table cellspacing='0' cellpadding='0'>
							                    			...
							                    			<td class="widget-area-style">
					   											<textarea class="encode_output <#if commentsRequired>mandatory</#if>" name="comments" cols="40" rows="4" id="WorkEffortAssignmentViewManagementFormPanel_comments" <#if commentsReadOnly || isReadOnlyRow> readonly="readonly"</#if>>${comments?if_exists}</textarea>
					   										</td>
						                    				<td class="label">
					   											<table cellspacing="0" cellpadding="0">
					   												<tbody>
					   										...
					   										<td class="widget-area-style">
			                    								<textarea class="encode_output <#if commentsRequired>mandatory</#if>" name="commentsLang" cols="40" rows="4" id="WorkEffortAssignmentViewManagementFormPanel_commentsLang" <#if commentsReadOnly || isReadOnlyRow> readonly="readonly"</#if>>${commentsLang?if_exists}</textarea>
			                    							</td>
				                    					</#if>
			   																...
			   																<td class="widget-area-style">
			   																	<div  class="droplist_field" id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe1">
																				    ...
																				    <div class="droplist_container">
																					    ...
																					    <input <#if commentsReadOnly || isReadOnlyRow>readonly="readonly"</#if> type="text"id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe1_edit_field" name="workEffortName_endWorkEffortIdWe1" size="45" maxlength="255" value="${endWorkEffortIdWeValue1}"  class="droplist_edit_field"/>
			   																...
			   																<td class="widget-area-style">
			   																	<div  class="droplist_field" id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe2">
																				    ...
																				    <div class="droplist_container">
																						...
																						<input <#if commentsReadOnly || isReadOnlyRow >readonly="readonly"</#if> type="text"id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe2_edit_field" name="workEffortName_endWorkEffortIdWe2" size="45" maxlength="255" value="${endWorkEffortIdWeValue2}"  class="droplist_edit_field"/>
																					    <span class="droplist-anchor"><a class="droplist_submit_field fa fa-2x" href="#"></a></span>
																					</div>
																				</div>
			   																</td>
		   																...
		   																<td class="widget-area-style">
		   																	<div class="droplist_field" id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe3">
																			    ...
																			    <div class="droplist_container">
																					...
																					<input <#if commentsReadOnly  || isReadOnlyRow>readonly="readonly"</#if> type="text"id="WorkEffortAssignmentViewManagementFormPanel_endWorkEffortIdWe3_edit_field" name="workEffortName_endWorkEffortIdWe3" size="45" maxlength="255" value="${endWorkEffortIdWeValue3}"  class="droplist_edit_field"/>
																				    <span class="droplist-anchor"><a class="droplist_submit_field fa fa-2x" href="#"></a></span>
																				</div>
																			</div>
		   																</td>
