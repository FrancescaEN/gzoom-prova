...
parameters.contentId = "WEFLD_WEFROM";
Debug.log("executeChildPerformFindWorkEffortAssocExtFrom Obiettivo search " + context.entityName + " with condition " + context.inputFields + ", then filter with contentId = " + parameters.contentId);	
