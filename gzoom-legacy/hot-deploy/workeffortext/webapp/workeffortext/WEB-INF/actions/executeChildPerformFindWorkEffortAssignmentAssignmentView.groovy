...
context.showRoleTypeWeight = "Y"; // Y, N, ALWAYS
context.showRoleTypeWeightActual = "N"; // Y, N, ALWAYS
context.showAvailability = "Y"; // Y, N, NOCHECK
context.showDates = "N";
context.typeEmployment = "";
context.startDate = "BEGIN";
context.usePeriod = "";
context.showComment = "N";
context.showEmployment = "N"; // Y, N
context.showEvaluable = "N"; // Y, N
...
context.partyIdTitleAreaClass = "";
context.personEmploymentTitleAreaClass = "";
context.categoryTitleAreaClass = "";
context.categoryLangTitleAreaClass = "";
context.profileTitleAreaClass = "";
context.profileLangTitleAreaClass = "";
context.roleTypeWeightActualTitleAreaClass = "";
context.roleTypeWeightTitleAreaClass = "";
context.periodFromDateTitleAreaClass = "";
context.periodThruDateTitleAreaClass = "";
context.fromDateTitleAreaClass = "";
context.thruDateTitleAreaClass = "";
context.employmentAmountTitleAreaClass = "";
context.availabilityTitleAreaClass = "";
context.wepaRoleTypeWeightTitleAreaClass = "";
context.endDateTitleAreaClass = "";
context.endCauseEnumIdTitleAreaClass = "";
context.endReplacementEnumIdTitleAreaClass = "";
context.endWorkEffortIdTitleAreaClass = "";
...
//****************** se non ho inserito il roleTypeId di default e' = WE_ASSIGNMENT
