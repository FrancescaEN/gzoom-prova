    	...
    	if (UtilValidate.isNotEmpty(workEffortAssocTypeListWETATO)) {
    		workEffortAssocTypeListWETATO.each { workEffortAssocTypeWETATO ->
    		    if("Y".equals(workEffortAssocTypeWETATO.hasResp)) {
                    ...
                    context["completeValue" + uniqueWorkEffortAssocIndexWETATO] = "";
                    context["partialValue" + uniqueWorkEffortAssocIndexWETATO] = "";
                    context["workEffortNameDescription" + uniqueWorkEffortAssocIndexWETATO] = "";
                    
    			    // default poi sovrascritti da paramas
                    context["onlyOpenDate" + uniqueWorkEffortAssocIndexWETATO] = "N";
    				...
    				if (UtilValidate.isNotEmpty(mapParams)) {
    				    context["onlyOpenDate" + uniqueWorkEffortAssocIndexWETATO] = mapParams.onlyOpenDate;
    				...
    				// Debug.log("showEtch " + context["showEtch" + uniqueWorkEffortAssocIndexWETATO]);
                    // Debug.log("showOrgUnit " + context["showOrgUnit" + uniqueWorkEffortAssocIndexWETATO]);
                    // Debug.log("completeValue " + context["completeValue" + uniqueWorkEffortAssocIndexWETATO]);
                    // Debug.log("partialValue " + context["partialValue" + uniqueWorkEffortAssocIndexWETATO]);
                    if (UtilValidate.isNotEmpty(context["showOrgUnit" + uniqueWorkEffortAssocIndexWETATO]) && !"N".equals(context["showOrgUnit" + uniqueWorkEffortAssocIndexWETATO])) {
    			        context["orderByField" + uniqueWorkEffortAssocIndexWETATO] = context.weOrgPartyDescrField;
    			        context["completeValue" + uniqueWorkEffortAssocIndexWETATO] = context.weOrgPartyDescrField;
    			        ...
    			        if ("R".equals(context["showOrgUnit" + uniqueWorkEffortAssocIndexWETATO])) {
    			            context["orderByField" + uniqueWorkEffortAssocIndexWETATO] = "weParentName";
    			            context["completeValue" + uniqueWorkEffortAssocIndexWETATO] = "";
    			            context["partialValue" + uniqueWorkEffortAssocIndexWETATO] = context.weParentNameField;
    			            context["workEffortNameValue" + uniqueWorkEffortAssocIndexWETATO] = context.workEffortNameField;
    			            context["workEffortNameDescription" + uniqueWorkEffortAssocIndexWETATO] = "Y".equals(context.localeSecondarySet) ?  "@{weParentNameLang} - @{workEffortNameLang}" : "@{weParentName} - @{workEffortName}";
    			        } else if ("A".equals(context["showOrgUnit" + uniqueWorkEffortAssocIndexWETATO])) {
    			            context["orderByField" + uniqueWorkEffortAssocIndexWETATO] = "weOrgPartyDescr";
    			            context["completeValue" + uniqueWorkEffortAssocIndexWETATO] = "";
    			            context["partialValue" + uniqueWorkEffortAssocIndexWETATO] = context.weOrgPartyDescrField;
    			            context["workEffortNameValue" + uniqueWorkEffortAssocIndexWETATO] = context.workEffortNameField;
    			            context["workEffortNameDescription" + uniqueWorkEffortAssocIndexWETATO] = "Y".equals(context.localeSecondarySet) ?  "@{weOrgPartyDescrLang} - @{workEffortNameLang}" : "@{weOrgPartyDescr} - @{workEffortName}";
    			        }
                    } else {
                        ...
                        if ("Y".equals(context["showEtch" + uniqueWorkEffortAssocIndexWETATO])) {
                            context["workEffortNameDescription" + uniqueWorkEffortAssocIndexWETATO] = "@{weEtch}";
                            context["partialValue" + uniqueWorkEffortAssocIndexWETATO] = "weEtch";
    			            ...
    			            context["workEffortNameDescription" + uniqueWorkEffortAssocIndexWETATO] = "@{sourceReferenceId}";
    		                context["partialValue" + uniqueWorkEffortAssocIndexWETATO] = "sourceReferenceId";
    	...
    	if (UtilValidate.isNotEmpty(workEffortAssocTypeListWETAFROM)) {
    		workEffortAssocTypeListWETAFROM.each { workEffortAssocTypeWETAFROM ->
    			if("Y".equals(workEffortAssocTypeWETAFROM.hasResp)) {
                    ...
                    context["completeValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "";
                    context["partialValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "";
                    context["workEffortNameDescription" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "";
                    
                    // default poi sovrascritti da params
                    context["onlyOpenDate" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "N";
                    ...
                    if (UtilValidate.isNotEmpty(mapParams)) {  
                        context["onlyOpenDate" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = mapParams.onlyOpenDate;
                    ...
                    if (UtilValidate.isNotEmpty(context["showOrgUnit" + (uniqueWorkEffortAssocIndexWETAFROM + 5)]) && !"N".equals(context["showOrgUnit" + (uniqueWorkEffortAssocIndexWETAFROM + 5)])) {
                        context["orderByField" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.weOrgPartyDescrField;
                        context["completeValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.weOrgPartyDescrField;
                        ...
                        if ("R".equals(context["showOrgUnit" + (uniqueWorkEffortAssocIndexWETAFROM + 5)])) {
                            context["orderByField" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "weParentName";
                            context["completeValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "";
                            context["partialValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.weParentNameField;
                            context["workEffortNameValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.workEffortNameField;
                            context["workEffortNameDescription" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "Y".equals(context.localeSecondarySet) ?  "@{weParentNameLang} - @{workEffortNameLang}" : "@{weParentName} - @{workEffortName}";
                        } else if ("A".equals(context["showOrgUnit" + (uniqueWorkEffortAssocIndexWETAFROM + 5)])) {
                            context["orderByField" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "weOrgPartyDescr";
                            context["completeValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "";
                            context["partialValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.weOrgPartyDescrField;
                            context["workEffortNameValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = context.workEffortNameField;
                            context["workEffortNameDescription" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "Y".equals(context.localeSecondarySet) ?  "@{weOrgPartyDescrLang} - @{workEffortNameLang}" : "@{weOrgPartyDescr} - @{workEffortName}";
                        }
                    } else{
                        ...
                        if ("Y".equals(context["showEtch" + (uniqueWorkEffortAssocIndexWETAFROM + 5)])) {
                            context["workEffortNameDescription" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "@{weEtch}";
                            context["partialValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "weEtch";
                            ...
                            context["workEffortNameDescription" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "@{sourceReferenceId}";
                            context["partialValue" + (uniqueWorkEffortAssocIndexWETAFROM + 5)] = "sourceReferenceId";
