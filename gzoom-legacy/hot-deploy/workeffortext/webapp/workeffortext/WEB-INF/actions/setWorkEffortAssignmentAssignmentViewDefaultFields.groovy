...
/*Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.fromDate " + context.fromDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.thruDate " + context.thruDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.defaultFromDate " + context.defaultFromDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.defaultThruDate " + context.defaultThruDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.startDate " + context.startDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.we " + context.we);*/
def fromDate = null;
...
/*Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.periodFromDate " + context.periodFromDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.periodThruDate " + context.periodThruDate);
Debug.log("setWorkEffortAssignmentAssignmentViewDefaultFields context.usePeriod " + context.usePeriod);*/
def periodFromDate = "";
...
if (UtilValidate.isNotEmpty(partyId)) {
	def personFieldsServiceMap = ["partyId": partyId,
	                              ...
	                              "showEmployment": context.showEmployment,
	...
	if (UtilValidate.isNotEmpty(personFieldsServiceRes)) {
		...
		if (UtilValidate.isNotEmpty(personFieldsServiceRes.personEmployment)) {
		    personEmployment = personFieldsServiceRes.personEmployment;
        }
	}
}
// Debug.log("personAllocation " + personAllocation);
// Debug.log("personEmployment " + personEmployment);
...
context.personEmployment = personEmployment;