...
// se presente il params assocParentSelected 15APSARR allora l'uo deve essere utilizzata per legare fra loro i workEffort
// Debug.log("context.assocParentSelected " + context.assocParentSelected + " orgUnitId " + orgUnitId + " parameters.orgUnitId " + parameters.orgUnitId + " context.parentWe " + context.parentWe);
if (UtilValidate.isNotEmpty(context.assocParentSelected)) {
    context.orgUnitIdRef = orgUnitId;
}
