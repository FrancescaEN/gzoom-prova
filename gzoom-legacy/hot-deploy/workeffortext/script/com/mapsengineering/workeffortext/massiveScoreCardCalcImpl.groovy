...
def uvUserLoginId = UtilValidate.isNotEmpty(context.uvUserLoginId) ? context.uvUserLoginId : "";
...
searchParameters.uvUserLoginId = UtilValidate.isNotEmpty(context.uvUserLoginId) ? context.uvUserLoginId : "";
