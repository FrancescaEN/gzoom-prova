...
// i groovy possono riotrnare solo String
returnMap = "success";

def workEffortId = parameters.workEffortId;
def allegatoContentId = parameters.allegatoContentId;
def condition = EntityCondition.makeCondition(EntityCondition.makeCondition("workEffortId", workEffortId), EntityCondition.makeCondition("allegatoContentId", allegatoContentId));
