...
Debug.log("Script getWorkEffortTypeInfo.groovy parameters.parentAssocTypeId " + parameters.parentAssocTypeId + " parameters.workEffortTypeId " + parameters.workEffortTypeId);
...
if (UtilValidate.isNotEmpty(getWefldMainParamsServiceOutMap)) {
	...
	codeReadOnly = getWefldMainParamsServiceOutMap.get("codeReadOnly");
	uorespReadOnly = getWefldMainParamsServiceOutMap.get("uorespReadOnly");
...
Debug.log("Run action script in " + (nowStamp2.getTime() - nowStamp.getTime()) + " milliseconds. script = component://workeffortext/script/com/mapsengineering/workeffortext/getWorkEffortTypeInfo.groovy");
