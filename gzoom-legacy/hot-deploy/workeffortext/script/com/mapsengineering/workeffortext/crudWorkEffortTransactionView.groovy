...
// Debug.log("crudWorkEffortTransactionView.groovy ****************** parameters.acctgTransTypeId " + parameters.acctgTransTypeId);
// Debug.log("crudWorkEffortTransactionView.groovy ****************** parameters.weTransValueKpiScore" + parameters.weTransValueKpiScore);
// Debug.log("crudWorkEffortTransactionView.groovy ****************** parameters.weTransValue" + parameters.weTransValue);

localParameters.acctgTransTypeId = parameters.acctgTransTypeId;
...
if (UtilValidate.isNotEmpty(parameters.contentIdInd)) {
    ...
    if ("WEFLD_IND6".equals(parameters.contentIdInd)) {
        contentId = "WEFLD_AIND6";
    }
    if ("WEFLD_IND7".equals(parameters.contentIdInd)) {
        contentId = "WEFLD_AIND7";
    }
    if ("WEFLD_IND8".equals(parameters.contentIdInd)) {
        contentId = "WEFLD_AIND8";
    }
    if ("WEFLD_IND9".equals(parameters.contentIdInd)) {
        contentId = "WEFLD_AIND9";
    }
    if ("WEFLD_IND10".equals(parameters.contentIdInd)) {
