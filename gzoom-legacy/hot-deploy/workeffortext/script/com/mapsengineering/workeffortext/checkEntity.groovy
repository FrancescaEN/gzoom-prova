...
Debug.log("checkEntity parameters.entityName " + parameters.entityName);
...
} else if ("WorkEffortRootView".equals(parameters.entityName) || "WorkEffortRootSimpleView".equals(parameters.entityName)) {
    res = "workEffortRoot";
