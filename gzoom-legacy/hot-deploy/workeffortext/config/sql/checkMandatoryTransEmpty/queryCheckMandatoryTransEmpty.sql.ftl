...
<@table "WORK_EFFORT"/> SK
    ...
    WHERE
        WTSC.CTRL_AMOUNT_ENUM_ID <> 'AMOUNT_NONE'
            ...
            AND WTSC.CONTENT_ID = 'WEFLD_AIND5')
            OR (WTC.CONTENT_ID = 'WEFLD_IND6'
            AND WTSC.CONTENT_ID = 'WEFLD_AIND6')
            OR (WTC.CONTENT_ID = 'WEFLD_IND7'
            AND WTSC.CONTENT_ID = 'WEFLD_AIND7')
            OR (WTC.CONTENT_ID = 'WEFLD_IND8'
            AND WTSC.CONTENT_ID = 'WEFLD_AIND8')
            OR (WTC.CONTENT_ID = 'WEFLD_IND9'
            AND WTSC.CONTENT_ID = 'WEFLD_AIND9')
            OR (WTC.CONTENT_ID = 'WEFLD_IND10'
            AND WTSC.CONTENT_ID = 'WEFLD_AIND10'))) WF ON WF.WORK_EFFORT_TYPE_ID = OB.WORK_EFFORT_TYPE_ID
        INNER JOIN
