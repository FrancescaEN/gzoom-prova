...
public enum E {
	...
	//
	// QueryConfig, queryActive, queryType, A, R, queryCode, cond0Info, histJobLogId, queryExecutorService, queryId,
	//
	WorkEffortTypeStatus, workEffortTypeRootId, currentStatusId, statusId, WorkEffortTypeStatusCnt, MESSAGE, MESSAGE_LANG, statusCheck, statusExecute,
	//
	saveExecute, saveExecuteContentId, saveExecuteWorkEffortId, saveExecuteOperation, C, U, D
}
