...
public class CheckHasQueryConfigErrorService extends GenericService {
   ...
   /**
    ...
    public void mainLoop() {
        ...
        try {
            ...
            if(UtilValidate.isNotEmpty(statusCheck)) {
                ...
                List<GenericValue> queryList = findList(FIELDS.QueryConfig.name(), condition, false, null);
    ...
    private List<EntityCondition> getQueryConfigConditions(String statusCheck) throws EvalError, GeneralException {
        ...
        conditionList.add(EntityCondition.makeCondition(FIELDS.queryType.name(), FIELDS.R.name()));
        conditionList.add(EntityCondition.makeCondition(FIELDS.queryActive.name(), E.Y.name()));
        conditionList.add(EntityCondition.makeCondition(FIELDS.queryCode.name(), EntityOperator.LIKE, "%" + statusCheck + "%"));
