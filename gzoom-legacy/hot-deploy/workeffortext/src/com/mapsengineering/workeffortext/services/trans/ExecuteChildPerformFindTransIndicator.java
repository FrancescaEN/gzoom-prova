...
public class ExecuteChildPerformFindTransIndicator extends GenericService {
    ...
    protected Map<String, Object> getGenericValue(ResultSet ele) throws SQLException {
        ...
        genericValue.put("source", ele.getString(WTI.SOURCE.name()));
        ...
        genericValue.put("comments2", ele.getString(WTI.COMMENTS2.name()));
        genericValue.put("comments2Lang", ele.getString(WTI.COMMENTS2_LANG.name()));
        ...
        genericValue.put("glAccountClassId", ele.getString(WTI.GL_ACCOUNT_CLASS_ID.name()));
        genericValue.put("glAccountClassDescr", ele.getString(WTI.GL_ACCOUNT_CLASS_DESCR.name()));
