 ...
 */
public enum WTI {
    workEffortId, glFiscalTypeId, glFiscalTypeIdList, weTransDate, weTransCurrencyUomId, contentId, workEffortMeasureId, weTransTypeValueId, hasMandatoryBudgetEmpty,
    //
    showPeriods, showDetail, showColumnScoreKpi, onlyWithBudget, accountFilter, mostraMovimenti, mostraSoggetti, mostraPossibiliPeriodi, organizationId,
    //
    CustomTimePeriod, fromDate, thruDate, periodTypeId, masterCustomTimePeriodId, weFirstCustomTimePeriodId, weFirstThruDate, customTimePeriodIdList, customTimePeriodList, customTimePeriodId, periodElapsed, scrollInt,
    //
    ...
    //
    AMOUNT_KPI_SCORE, ORIG_AMOUNT_KPI_SCORE, AMOUNT_LOCKED_KPI_SCORE,
    //
    WE_TRANS_COMMENT_KPI_SCORE, WE_TRANS_COMMENT_LANG_KPI_SCORE, WE_TRANS_COMMENTS_KPI_SCORE, WE_TRANS_COMMENTS_LANG_KPI_SCORE,
    //
    IS_POSTED_KPI_SCORE, WE_TRANS_ID_KPI_SCORE, WE_TRANS_ENTRY_ID_KPI_SCORE, KPI_SCORE_UOM_TYPE, KPI_SCORE_DECIMAL_SCALE, 
    //
    ...
    //
    FROM_DATE, THRU_DATE, P_FROM_DATE, P_THRU_DATE, C_DESCRIPTION_LANG, GT_DESCRIPTION_LANG, COMMENTS_LANG, WORK_EFFORT_TYPE_PERIOD_ID, SOURCE, COMMENTS2, COMMENTS2_LANG, GL_ACCOUNT_CLASS_ID, GL_ACCOUNT_CLASS_DESCR
}
