...
public abstract class ValueConverter extends BaseConverter {
    ...
    /**
     * ritorna il valore se presente, altrimenti null
     * @param currentKpi
     * @param fieldName
     * @return
     */
    protected Double getDoubleValue(Map<String, Object> currentKpi, String fieldName) {
        return (currentKpi.get(fieldName) != null) ? (Double)currentKpi.get(fieldName) : null;
    }
