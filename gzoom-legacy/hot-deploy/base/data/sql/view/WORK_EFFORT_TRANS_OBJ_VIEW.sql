CREATE VIEW WORK_EFFORT_TRANS_OBJ_VIEW (
...
FROM WORK_EFFORT_MEASURE A
  ...
  LEFT JOIN ACCTG_TRANS_VIEW G ON G.B_GL_ACCOUNT_ID <> 'SCOREKPI' 
     ...
     AND E.INPUT_ENUM_ID = 'ACCINP_OBJ' AND G.B_VOUCHER_REF IS NOT NULL AND A.WORK_EFFORT_MEASURE_ID = G.B_VOUCHER_REF
     AND (B.WORK_EFFORT_SNAPSHOT_ID IS NULL AND G.A_WORK_EFFORT_SNAPSHOT_ID IS NULL
       OR B.WORK_EFFORT_SNAPSHOT_ID = G.A_WORK_EFFORT_SNAPSHOT_ID)
