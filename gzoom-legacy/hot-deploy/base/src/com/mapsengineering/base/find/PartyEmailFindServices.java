...
public class PartyEmailFindServices extends BaseFindServices {
    ...
    public List<GenericValue> getEmailAddress(String partyId) throws GeneralException {
        ...
        return getDelegator().findList("PartyContactWithPurpose", EntityCondition.makeCondition(conditionList), null, UtilMisc.toList("infoString"), null, false);
    }
     ...
     * @throws GeneralException
     */
    public List<GenericValue> getEmailAddress(String partyId, String defaultOrganizationPartyId) throws GeneralException {
        List<EntityCondition> conditionList = getBaseConditionList();
        ...
        if (UtilValidate.isNotEmpty(defaultOrganizationPartyId)) {
            conditionList.add(EntityCondition.makeCondition("organizationId", defaultOrganizationPartyId));
        }
        
        EntityFindOptions entityFindOption = new EntityFindOptions();
        entityFindOption.setDistinct(true);
        return getDelegator().findList("PartyContactWithPurposeAndOrganization", EntityCondition.makeCondition(conditionList), null, UtilMisc.toList("infoString"), entityFindOption, false);
    }
     ...
     * @throws GeneralException
     */
    public List<GenericValue> getEmailAddresses(List<String> partyIdList, String defaultOrganizationPartyId) throws GeneralException {
        List<EntityCondition> conditionList = getBaseConditionList();
        ...
        EntityFindOptions entityFindOption = new EntityFindOptions();
        entityFindOption.setDistinct(true);
        return getDelegator().findList("PartyContactWithPurposeAndOrganization", EntityCondition.makeCondition(conditionList), null, null, null, false);
    }
    ...
    public List<GenericValue> getEmailAddresses(List<String> partyIdList) throws GeneralException {
        ...
        return getDelegator().findList("PartyContactWithPurpose", EntityCondition.makeCondition(conditionList), null, null, null, false);
    }
