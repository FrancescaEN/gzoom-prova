...
public class Utils {
     ...
     * @param weContextId
     * @param userLogin
     * @param excludeViewAdminView, se deve essere fatto il controllo per vedere tutte le UO o solo quelle di sua competenza
     * @param workEffortRevisionId
     * @return
     */
    public static Map<String, Object> getMapUserPermision(Security security, String weContextId, GenericValue userLogin, Boolean excludeViewAdminView, String workEffortRevisionId) {
        ...
        // le UO devono essere filtrate se un utente NON e' VIEW_ADMIN oppure si trova in una schermata in cui le UO devono essere filtrate
