...
public class UtilDateTime {
	...
	public static Date getDateFromDayMonthYear(int day, String monthStr, TimeZone timeZone, int year, Locale locale) {
		Date res=null;
		if (monthStr != null && locale != null) {
			if (timeZone == null) {
				timeZone = TimeZone.getDefault();
	...
	public static Date getDateFromDayMonthYear(int day, String monthStr, String timeZone, int year, Locale locale) {
		TimeZone currentTimeZone = null;
		if (UtilValidate.isNotEmpty(timeZone)) {
			currentTimeZone = TimeZone.getTimeZone(timeZone);
		} else {
		...
		return getDateFromDayMonthYear(day, monthStr, currentTimeZone, year, locale);
	}	
