...
public class AsyncJobCleaner {
    ...
    enum E {
        ...
        createdDate, objectInfo, communicationEventId, completedStamp, activityId, delContentDataResource, createdStamp, status
    }
    ...
    public void cleanActivity() throws GeneralException {
        ...
        conditionList.add(EntityCondition.makeCondition(E.status.name(), "FAILED"));
		conditionList.add(EntityCondition.makeCondition(E.createdStamp.name(), EntityOperator.LESS_THAN_EQUAL_TO, tsBeforeDelete));
		
		EntityCondition condition = EntityCondition.makeCondition( //
				( EntityCondition.makeCondition(E.completedStamp.name(), EntityOperator.LESS_THAN_EQUAL_TO, tsBeforeDelete)), //
                EntityOperator.OR, //
