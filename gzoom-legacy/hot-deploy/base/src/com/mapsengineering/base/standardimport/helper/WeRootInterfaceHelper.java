...
public class WeRootInterfaceHelper {
     ...
     * Controlla validita dei dati passati, quindi con quel sourceReferenceId e quel workEffortTypeId e workEffortSnapshotId = null,
    ...
    public GenericValue getValidWorkEffortRoot(String sourceReferenceId, String organizationId, String workEffortTypeId, String operationType) throws GeneralException {
        ...
        List<GenericValue> parents = getWorkEffortList(sourceReferenceId, workEffortTypeId, organizationId);

        if (UtilValidate.isNotEmpty(parents) && parents.size() > 1) {
            msg = "Found more than one workEffort with empty workEffortSnapshotId and sourceReferenceId = " + sourceReferenceId + "and workEffortTypeId = " + workEffortTypeId;
    ...
    /**
     * Ricerca e restituisce il primo workEffort, a partire dal sourceReferenceId e dalla tipologia workEffortTypeId (se passata), con workEffortSnapshotId vuoto
     * @param sourceReferenceId
     * @param workEffortTypeId
     ...
     * @throws GeneralException
     */
    public GenericValue getWorkEffort(String sourceReferenceId, String workEffortTypeId, String organizationId) throws GeneralException {
        return EntityUtil.getFirst(getWorkEffortList(sourceReferenceId, workEffortTypeId, organizationId));
    }
    ...
    /**
     * Ricerca workEffort a partire dal sourceReferenceId e dalla tipologia workEffortTypeId (se passata), con snapshot vuoto
     * @param sourceReferenceId
     * @param workEffortTypeId
     * @param organizationId
     * @return
     * @throws GeneralException
     */
    public List<GenericValue> getWorkEffortList(String sourceReferenceId, String workEffortTypeId, String organizationId) throws GeneralException {
        ...
        if (UtilValidate.isNotEmpty(workEffortTypeId)) {
            cond = EntityCondition.makeCondition( cond,
                    EntityCondition.makeCondition(E.workEffortTypeId.name(), workEffortTypeId)
            );
        }
