...
public abstract class TakeOverService {
    ...
    /**
     * Eventuale record presente sul db
     */
    private GenericValue localValue = null;
    
    /**
     * Record presente sulla tabella di interfaccia
     */
    ...
    /**
     * @return the localValue, eventuale record presente sul db
     */
    ...
    /**
     * @return the externalValue, record presente sulla tabella di interfaccia
     */
    ...
    public void addLogDebug(String logCode, String logMessage, String key, String valueRef2, String valueRef3, String module) {
        ...
        manager.addLogDebug(logCode, logMessage, key, valueRef2, valueRef3, module);
    }
