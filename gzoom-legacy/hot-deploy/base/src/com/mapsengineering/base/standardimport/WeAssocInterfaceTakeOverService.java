...
/**
 * Elaborate assoc for workEffort
 *
 */
public class WeAssocInterfaceTakeOverService extends WeBaseInterfaceTakeOverService {
    ...
    /**
     * Tipologia della scheda utilizzata per validare la relazione
     */
    ...
    /**
     * Codice della scheda dell'obiettivo from della relazione
     */
    private String sourceReferenceRootIdFrom;
    
    /**
     * Tipologia dell'obiettivo from della relazione
     */
    private String workEffortTypeIdFrom;
    
    /**
     * Tipologia dell'obiettivo to della relazione
     */
    private String workEffortTypeIdTo;
    
    /**
     * Codice della scheda dell'obiettivo to della relazione
     */
    private String sourceReferenceRootIdTo;
    
    /**
     * Id dell'obiettivo from della relazione
     */
    private String workEffortIdFrom;
    
    /**
     * Id dell'obiettivo to della relazione
     */
    ...
    /**
     * Codice della scheda da cui parte importazione
     */
    ...
    public void initLocalValue(Map<String, ? extends Object> extLogicKey) throws GeneralException {
        ...
        String msg = " Try workEffort with sourceReferenceRootId " + sourceReferenceRootId + " and type " + getWorkEffortRootTypeId();
        addLogInfo(msg);
        ...
        GenericValue weRoot = getWeRootInterfaceHelper().getWorkEffort(sourceReferenceRootId, getWorkEffortRootTypeId(), getOrganizationId());
    ...
    private void checkValidityWorkEffortTo() throws GeneralException {
        ...
        String msg = "Try workEffort with sourceReferenceRootIdTo " + sourceReferenceRootIdTo;
        addLogInfo(msg);
    ...
    private void checkValidityWorkEffortFrom() throws GeneralException {
        ...
        String sourceReferenceIdFrom = externalValue.getString(E.sourceReferenceIdFrom.name());
        String sourceReferenceIdTo = externalValue.getString(E.sourceReferenceIdTo.name());
        String msg = "Try workEffort with sourceReferenceRootIdFrom " + sourceReferenceRootIdFrom;
        addLogInfo(msg);
