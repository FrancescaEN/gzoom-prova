...
public abstract class WeBaseInterfaceTakeOverService extends WorkEffortCommonTakeOverService {
    ...
    public void initLocalValue(Map<String, ? extends Object> extLogicKey) throws GeneralException {
        ...
        String workEffortTypeId = getWorkEffortRootTypeId();
        Map<String, Object> logParameters = UtilMisc.toMap(E.sourceReferenceId.name(), (Object) sourceReferenceId, E.workEffortTypeId.name(), workEffortTypeId);
        JobLogLog tryWorkEffort = new JobLogLog().initLogCode(BaseImportManager.RESOURCE_LABEL, "WE_TRY", logParameters, getManager().getLocale());
        addLogDebug(tryWorkEffort.getLogCode(), tryWorkEffort.getLogMessage(), null, BaseImportManager.RESOURCE_LABEL, tryWorkEffort.getParametersJSON(), MODULE);
        ...
        getWeRootInterfaceHelper().getWorkEffort(sourceReferenceRootId, workEffortTypeId, getOrganizationId());
