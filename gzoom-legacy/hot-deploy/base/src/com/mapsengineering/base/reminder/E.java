...
public enum E {
    ...
    JobLog,
    //
    userLogin, asyncJobn, enabledSendMail, list, userProfile, outputFormat, contentType, locale, partyId, evalPartyId, contactMechId, queryReminder, localDispatcherName,
    //
    batchReminder, retrieveWorkEffortReminder, skipCommEventContentAssoc, 
    //
    ...
    QueryConfig, queryActive, queryType, R, E, queryCode, cond0Info, histJobLogId, queryExecutorService, queryId, queryName, description
}
