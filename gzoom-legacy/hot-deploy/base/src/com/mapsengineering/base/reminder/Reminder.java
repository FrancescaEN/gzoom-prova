...
public class Reminder extends GenericService {
	...
	public void mainLoop() {
        ...
        try {
            ...
            // TODO solo per alcuni, per createCommunicationEventAndSendMail
            if ("REMINDER_ASS_OBI_1".equals(context.get(E.reportContentId.name())) || "REMINDER_VAL_DIP_1".equals(context.get(E.reportContentId.name()))
                    || "REMINDER_ASSOBI1_22".equals(context.get(E.reportContentId.name())) || "REMINDER_VALDIP1_22".equals(context.get(E.reportContentId.name()))){
                context.put(E.skipCommEventContentAssoc.name(), true);
            }
