...
export class GaugeComponent implements OnInit, OnChanges {
  ...
  gaugeValue = 0;        //Specifies the current value of the Gauge in the range specified by min and max. It is a required attribute.
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes && changes["gaugeConfig"]) {
      ...
      //this.tmpMarkerConfig[this.gaugeValue.toString()] = { color: '#555', size: 10, type: 'triangle' }
      let i = 0;
      ...
      /*
            this.tmpMarkerConfig[this.gaugeConfig.fromValueYellow] = { color: '#555', size: 9, type: 'triangle' };
            this.tmpMarkerConfig[this.gaugeConfig.fromValueGreen] = { color: '#555', size: 9, type: 'triangle' };
      */
