...
export class TableComponent<A> implements AfterViewInit, OnChanges, OnInit {
  ...
  // formShape
  @Input() formShape: { [name: string]: UntypedFormGroup | UntypedFormControl | UntypedFormArray }
  ...
  constructor(private fb: UntypedFormBuilder, private viewportScroller: ViewportScroller) { }
  ...
  ngOnInit(): void {
    this.form = this.formShape? this.fb.group(this.formShape):  this.form;
    ...
    console.log( this.typeDropdownFilterArray);
