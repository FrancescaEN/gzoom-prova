...
@Pipe({ name: 'i18nIconFlagName' })
export class I18NIconFlagNamePipe implements PipeTransform {
  ...
  transform(value: number): string | null {
    return "assets/images/inconFlag/" + this.i18n.getNameIconFlag()[value] + ".png";
  }

}

@Pipe({ name: 'i18nLangType' })
export class I18NLangTypePipe implements PipeTransform {

  constructor(private readonly i18n: I18NService) {
  }

  // value is assumed to be a valid `moment` object
  transform(langType: string): boolean {
    return this.i18n.getLanguageType() == langType;
  }
