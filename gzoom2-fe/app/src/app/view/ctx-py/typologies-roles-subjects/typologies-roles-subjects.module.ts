...
import { TypologiesRolesSubjectsRoutingModule } from './typologies-roles-subjects-routing.module';
...
@NgModule({
  imports: [
    ...
    CardModule,
    MessagesModule,
    TypologiesRolesSubjectsRoutingModule,
    ProgressSpinnerModule
  ],
  declarations: [
    TypologiesRolesSubjectsComponent
  ],
  providers: [
...
export default class TypologiesRolesSubjectsModule {}
