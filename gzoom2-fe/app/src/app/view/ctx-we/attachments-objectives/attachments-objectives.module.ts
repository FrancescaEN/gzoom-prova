...
import { AttachmentsObjectivesComponent } from './attachments-objectives.component';
...
const routes: Routes = [
  {
    path: '',
    component: AttachmentsObjectivesComponent,
...
@NgModule({
  ...
  declarations: [
    AttachmentsObjectivesComponent
  ],
  providers: [
    ConfirmationService,
    // MessageService,
...
export default class AttachmentsObjectivesModule {}
