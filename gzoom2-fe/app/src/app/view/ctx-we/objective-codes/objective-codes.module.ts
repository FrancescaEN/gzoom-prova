...
import { workeEffortSequenceResolver } from 'app/api/resolver/work-effort-sequence-resolver.service';

const routes: Routes = [
  {
    path: '',
    component: ObjectiveCodesComponent,
    resolve: { objCod: workeEffortSequenceResolver },
...
export default class ObjectiveCodesModule {}
