...
import { NotesObjectivesComponent } from './notes-objectives.component';
...
const routes: Routes = [
  {
    path: '',
    component: NotesObjectivesComponent,
...
@NgModule({
  ...
  providers: [
    ...
    WorkEffortNoteService,
    WorkEffortTypeAttrService,
    MsgService,
    WorkEffortService

  ]
})
export default class NotesObjectivesModule {}
