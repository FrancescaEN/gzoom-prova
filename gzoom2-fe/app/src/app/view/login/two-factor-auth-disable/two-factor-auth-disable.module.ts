...
import { TwoFactorAuthDisableRoutingModule } from './two-factor-auth-disable-routing.module';
...
@NgModule({
  imports: [
    ...
    AutoFocusModule,
    DialogModule,
    TwoFactorAuthDisableRoutingModule
  ],
  providers: [
    NodeService,
    LdapService,
...
export default class TwoFactorAuthDisableModule { }
