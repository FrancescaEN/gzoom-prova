...
import { workEffortPurposeResolver } from 'app/api/resolver/work-effort-purpose-resolver.service';

const routes: Routes = [
  {
    path: '',
    component: PurposeComponent,
    resolve: { obss: workEffortPurposeResolver },
...
export default class PurposeModule {}
