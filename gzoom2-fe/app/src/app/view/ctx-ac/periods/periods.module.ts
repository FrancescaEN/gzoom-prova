...
import { customTimePeriodResolver } from 'app/api/resolver/custom-time-period-resolver.service';

const routes: Routes = [
  {
    path: '',
    component: PeriodsComponent,
    resolve: { obss: customTimePeriodResolver },
...
export default class PeriodsModule {}
